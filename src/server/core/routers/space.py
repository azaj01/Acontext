...
from acontext_core.env import LOG, DEFAULT_CORE_CONFIG
from acontext_core.schema.api.request import SearchMode, InsertBlockRequest
...
router = APIRouter(
    prefix="/api/v1/project/{project_id}/space/{space_id}", tags=["space"]
)
