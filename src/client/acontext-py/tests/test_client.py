...
@patch("acontext.client.AcontextClient.request")
def test_store_message_with_meta_parameter(
    mock_request, client: AcontextClient
) -> None:
...
@patch("acontext.client.AcontextClient.request")
def test_store_message_without_meta_parameter(
    mock_request, client: AcontextClient
) -> None:
...
@patch("acontext.client.AcontextClient.request")
def test_get_messages_returns_metas(
    mock_request, client: AcontextClient
) -> None:
...
@patch("acontext.client.AcontextClient.request")
def test_get_messages_empty_metas(
    mock_request, client: AcontextClient
) -> None:
...
@patch("acontext.client.AcontextClient.request")
def test_get_messages_missing_metas_field(
    mock_request, client: AcontextClient
) -> None:
...
@patch("acontext.client.AcontextClient.request")
def test_patch_message_meta_adds_new_keys(
    mock_request, client: AcontextClient
) -> None:
    ...
    result = client.sessions.patch_message_meta(
        "session-id",
        "message-id",
...
@patch("acontext.client.AcontextClient.request")
def test_patch_message_meta_updates_existing_keys(
    mock_request, client: AcontextClient
) -> None:
...
@patch("acontext.client.AcontextClient.request")
def test_patch_message_meta_deletes_keys_with_none(
    mock_request, client: AcontextClient
) -> None:
